...
class TestCreativeRepositoryCreate:
    ...
    def test_creates_and_flushes(self):
        ...
        result = repo.create(
            ...
            principal_id="p1",
            data={"assets": build_assets(image_spec("banner", url="https://example.com/banner.png"))},
        )
...
class TestCreativeRepositoryUpdateData:
    ...
    def test_sets_data_and_flags(self):
        ...
        fake_creative = MagicMock()
        new_data = {"assets": build_assets(image_spec("banner", url="https://new.example.com/banner.png"))}
